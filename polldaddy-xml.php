...
class Polldaddy_XML_Object extends Ghetto_XML_Object {
	var $___ns = 'pd';
	var $___ns_full = 'https://api.polldaddy.com/pdapi.xsd';
}
...
class Polldaddy_XML_Parser {
	...
	var $polldaddy_objects = array(
		'https://api.polldaddy.com/pdapi.xsd:pdAccess'      => 'Polldaddy_Access',
		'https://api.polldaddy.com/pdapi.xsd:pdInitiate'    => 'Polldaddy_Initiate',
		'https://api.polldaddy.com/pdapi.xsd:pdRequest'     => 'Polldaddy_Request',
		'https://api.polldaddy.com/pdapi.xsd:pdResponse'    => 'Polldaddy_Response',
		'https://api.polldaddy.com/pdapi.xsd:errors'        => 'Polldaddy_Errors',
		'https://api.polldaddy.com/pdapi.xsd:error'         => 'Polldaddy_Error',
		'https://api.polldaddy.com/pdapi.xsd:demands'       => 'Polldaddy_Demands',
		'https://api.polldaddy.com/pdapi.xsd:demand'        => 'Polldaddy_Demand',
		'https://api.polldaddy.com/pdapi.xsd:queries'       => 'Polldaddy_Queries',
		'https://api.polldaddy.com/pdapi.xsd:query'         => 'Polldaddy_Query',
		'https://api.polldaddy.com/pdapi.xsd:account'       => 'Polldaddy_Account',
		'https://api.polldaddy.com/pdapi.xsd:list'          => 'Polldaddy_List',
		'https://api.polldaddy.com/pdapi.xsd:polls'         => 'Polldaddy_Polls',
		'https://api.polldaddy.com/pdapi.xsd:search'        => 'Polldaddy_Search',
		'https://api.polldaddy.com/pdapi.xsd:poll'          => 'Polldaddy_Poll',
		'https://api.polldaddy.com/pdapi.xsd:emailAddress'  => 'Polldaddy_Email',
		'https://api.polldaddy.com/pdapi.xsd:message'       => 'Polldaddy_Email_Message',
		'https://api.polldaddy.com/pdapi.xsd:answers'       => 'Polldaddy_Poll_Answers',
		'https://api.polldaddy.com/pdapi.xsd:answer'        => 'Polldaddy_Poll_Answer',
		'https://api.polldaddy.com/pdapi.xsd:otherAnswers'  => 'Polldaddy_Other_Answers',
		'https://api.polldaddy.com/pdapi.xsd:result'        => 'Polldaddy_Poll_Result',
		'https://api.polldaddy.com/pdapi.xsd:comments'      => 'Polldaddy_Comments',
		'https://api.polldaddy.com/pdapi.xsd:comment'       => 'Polldaddy_Comment',
		'https://api.polldaddy.com/pdapi.xsd:extensions'    => 'Polldaddy_Extensions',
		'https://api.polldaddy.com/pdapi.xsd:folders'       => 'Polldaddy_Folders',
		'https://api.polldaddy.com/pdapi.xsd:folder'        => 'Polldaddy_Folder',
		'https://api.polldaddy.com/pdapi.xsd:styles'        => 'Polldaddy_Styles',
		'https://api.polldaddy.com/pdapi.xsd:style'         => 'Polldaddy_Style',
		'https://api.polldaddy.com/pdapi.xsd:packs'         => 'Polldaddy_Packs',
		'https://api.polldaddy.com/pdapi.xsd:pack'          => 'Polldaddy_Pack',
		'https://api.polldaddy.com/pdapi.xsd:languages'     => 'Polldaddy_Languages',
		'https://api.polldaddy.com/pdapi.xsd:language'      => 'Polldaddy_Language',
		'https://api.polldaddy.com/pdapi.xsd:activity'      => 'Polldaddy_Activity',
		'https://api.polldaddy.com/pdapi.xsd:rating_result' => 'Polldaddy_Rating_Result',
		'https://api.polldaddy.com/pdapi.xsd:ratings'       => 'Polldaddy_Ratings',
		'https://api.polldaddy.com/pdapi.xsd:rating'        => 'Polldaddy_Rating',
		'https://api.polldaddy.com/pdapi.xsd:nonce'         => 'Polldaddy_Nonce',
		'https://api.polldaddy.com/pdapi.xsd:partner'       => 'Polldaddy_Partner',
		'https://api.polldaddy.com/pdapi.xsd:media'         => 'Polldaddy_Media',
		'pack'                                              => 'Custom_Pack',
